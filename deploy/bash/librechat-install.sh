...
curl -fsSL https://download.docker.com/linux/ubuntu/gpg | sudo gpg --dearmor -o /usr/share/keyrings/docker-archive-keyring.gpg.temp && sudo mv /usr/share/keyrings/docker-archive-keyring.gpg.temp /usr/share/keyrings/docker-archive-keyring.gpg || check_error "curl"
